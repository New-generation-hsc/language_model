...
train_set = process.WordDataSet(word_tensor["train"], char_tensor["train"], 20, 35)
train_loader = DataLoader(train_set, batch_size=20, shuffle=False)

valid_set = process.WordDataSet(word_tensor["valid"], char_tensor["valid"], 20, 35)
valid_loader = DataLoader(valid_set, batch_size=20, shuffle=False)

test_set = process.WordDataSet(word_tensor["test"], char_tensor["test"], 20, 35)
